...
(function($) {
	...
	$.fn.datetimebox.parseOptions = function(_23) {
		var t = $(_23);
		return $.extend({}, $.fn.datebox.parseOptions(_23), $.parser
						.parseOptions(_23, ["timeSeparator", {
											showSeconds : "boolean"
										}]));
	};
	$.fn.datetimebox.defaults = $.extend({}, $.fn.datebox.defaults, {
		...
		formatter : function(_24) {
			...
			var r = $.fn.datebox.defaults.formatter(_24) + " " + _25(h) + _27
					+ _25(M);
		...
		parser : function(s) {
			...
			return new Date(d.getFullYear(), d.getMonth(), d.getDate(), _29,
					_2a, _2b);
		}
	});
})(jQuery);
