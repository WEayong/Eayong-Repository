...
(function($) {
		...
		$(_3).datagrid($.extend({}, _5, {
					...
					onClickRow : function(_7, _8) {
						...
						if (_5.editIndex != _7 && _8.editor) {
							var _9 = $(this).datagrid("getColumnOption",
									"value");
							_9.editor = _8.editor;
							_c(_1);
							$(this).datagrid("beginEdit", _7);
							$(this).datagrid("getEditors", _7)[0].target
									.focus();
							_5.editIndex = _7;
						}
					...
					onLoadSuccess : function(_b) {
						$(_3).datagrid("getPanel").find("div.datagrid-group")
								.attr("style", "");
	...
	$.fn.propertygrid = function(_10, _11) {
		...
		return this.each(function() {
					...
					if (_13) {
						...
						var _14 = $.extend({}, $.fn.propertygrid.defaults,
								$.fn.propertygrid.parseOptions(this), _10);
						_14.frozenColumns = $.extend(true, [],
								_14.frozenColumns);
	...
	$.fn.propertygrid.parseOptions = function(_15) {
		var t = $(_15);
		return $.extend({}, $.fn.datagrid.parseOptions(_15), $.parser
						.parseOptions(_15, [{
											showGroup : "boolean"
										}]));
	};
		...
		render : function(_16, _17, _18) {
			...
			for (var i = 0; i < _1f.length; i++) {
				...
				if (!_18) {
					...
					_1d
							.push(_1a.groupFormatter.call(_16, _20.fvalue,
									_20.rows));
					_1d.push("</span>");
				}
				_1d.push("</td>");
				...
				for (var j = 0; j < _20.rows.length; j++) {
					var cls = (_1e % 2 && _1a.striped)
							? "class=\"datagrid-row datagrid-row-alt\""
							: "class=\"datagrid-row\"";
					var _21 = _1a.rowStyler ? _1a.rowStyler.call(_16, _1e,
							_20.rows[j]) : "";
					var _22 = _21 ? "style=\"" + _21 + "\"" : "";
					var _23 = _19.rowIdPrefix + "-" + (_18 ? 1 : 2) + "-" + _1e;
					_1d.push("<tr id=\"" + _23 + "\" datagrid-row-index=\""
							+ _1e + "\" " + cls + " " + _22 + ">");
					_1d.push(this.renderRow.call(this, _16, _1c, _18, _1e,
							_20.rows[j]));
					_1d.push("</tr>");
					_1e++;
				}
			...
			_26.find("div.datagrid-group").each(function() {
				...
				$(this).find("span.datagrid-row-expander").bind("click", {
							...
							if ($(this).hasClass("datagrid-row-collapse")) {
								$(_24).datagrid("collapseGroup",
										e.data.groupIndex);
							} else {
								$(_24).datagrid("expandGroup",
										e.data.groupIndex);
							}
						});
			});
				...
				expandGroup : function(jq, _34) {
					return jq.each(function() {
								...
								if (_37.hasClass("datagrid-row-expand")) {
									_37.removeClass("datagrid-row-expand")
				...
				collapseGroup : function(jq, _38) {
					return jq.each(function() {
								...
								if (_3b.hasClass("datagrid-row-collapse")) {
									_3b.removeClass("datagrid-row-collapse")
