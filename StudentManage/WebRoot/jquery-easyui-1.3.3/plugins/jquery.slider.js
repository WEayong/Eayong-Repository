...
(function($) {
			...
			for (var i = 0; i < aa.length; i++) {
				...
				if (aa[i] != "|") {
					...
					if (_f.mode == "h") {
						_15.css({
									left : _14,
									marginLeft : -Math.round(_15.outerWidth()
											/ 2)
								});
					} else {
						_15.css({
									top : _14,
									marginTop : -Math.round(_15.outerHeight()
											/ 2)
								});
					}
				}
	...
	function _21(_22, _23) {
		...
		if (_25.mode == "h") {
			...
			tip.attr("style", _29 + "margin-left:"
	...
	function _28(_2c, _2d) {
		...
		if (_2f.mode == "h") {
			...
			var pos = _30.height() - (_2d - _2f.min) / (_2f.max - _2f.min)
					* _30.height();
			if (_2f.reversed) {
				pos = _30.height() - pos;
			}
	...
	function _31(_32, pos) {
		...
		if (_34.mode == "h") {
			...
			var _36 = _34.min + (_34.max - _34.min)
					* ((_35.height() - pos) / _35.height());
		}
