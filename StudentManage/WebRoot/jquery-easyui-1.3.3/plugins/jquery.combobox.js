...
(function($) {
	...
	function _b(_c, _d) {
		...
		if (!_10.length) {
			_10 = _f.children("div.combobox-item:visible:"
					+ (_d == "next" ? "first" : "last"));
		} else {
			if (_d == "next") {
	...
	$.fn.combobox.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
						...
						_4f.find("div.combobox-item-selected")
								.removeClass("combobox-item-selected");
					});
		},
		reset : function(jq) {
	...
	$.fn.combobox.parseOptions = function(_54) {
		var t = $(_54);
		return $.extend({}, $.fn.combo.parseOptions(_54), $.parser
						.parseOptions(_54, ["valueField", "textField", "mode",
										"method", "url"]));
	};
	$.fn.combobox.parseData = function(_55) {
		...
		$(_55).children("option").each(function() {
			var _58 = {};
			_58[_57.valueField] = $(this).attr("value") != undefined ? $(this)
