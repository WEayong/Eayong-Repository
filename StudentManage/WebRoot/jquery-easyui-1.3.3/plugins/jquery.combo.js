...
(function($) {
						...
						if (_1f.editable) {
							...
							_1e.timer = setTimeout(function() {
										...
										if (_1e.previousValue != q) {
											_1e.previousValue = q;
											$(_1d).combo("showPanel");
											_1f.keyHandler.query.call(_1d, _22
															.val());
											_2f(_1d, true);
										}
									}, _1f.delay);
	...
	function _24(_25) {
		...
		function _2a() {
			...
			if (_2b + _28._outerWidth() > $(window)._outerWidth()
					+ $(document).scrollLeft()) {
		...
		function _29() {
			...
			if (top + _28._outerHeight() > $(window)._outerHeight()
					+ $(document).scrollTop()) {
	...
	function _2f(_30, _31) {
		...
		_33.validatebox($.extend({}, _32, {
			deltaX : (_32.hasDownArrow ? _32.deltaX : (_32.deltaX > 0 ? 1 : -1))
		}));
		if (_31) {
	...
	function _17(_39, _3a) {
		...
		_3b.combo.find(".combo-text").attr("readonly",
				_3c.readonly ? true : (!_3c.editable));
	};
	function _3d(_3e) {
	...
	function _4d(_4e, _4f) {
		...
		for (var i = 0; i < _4f.length; i++) {
			var _54 = $("<input type=\"hidden\" class=\"combo-value\">")
					.appendTo(_52);
			if (_53) {
				_54.attr("name", _53);
			}
					...
					if (_60) {
						...
						_60 = $.data(this, "combo", {
									options : $.extend({}, $.fn.combo.defaults,
											$.fn.combo.parseOptions(this), _5e),
									combo : r.combo,
									panel : r.panel,
									previousValue : null
								});
	...
	$.fn.combo.parseOptions = function(_68) {
		var t = $(_68);
		return $.extend({}, $.fn.validatebox.parseOptions(_68), $.parser
						.parseOptions(_68, ["width", "height", "separator", {
											panelWidth : "number",
											editable : "boolean",
