...
(function($) {
			...
			_22.resizable($.extend({}, {
						...
						onResize : function(e) {
							if (dir == "north" || dir == "south") {
								...
								_28.css("top", e.pageY - $(_1c).offset().top
												- _28.height() / 2);
							} else {
								var _28 = $(">div.layout-split-proxy-h", _1c);
								_28.css("left", e.pageX - $(_1c).offset().left
												- _28.width() / 2);
							}
							return false;
						},
						onStopResize : function() {
							$(">div.layout-split-proxy-v", _1c).css("display",
									"none");
							$(">div.layout-split-proxy-h", _1c).css("display",
									"none");
	...
	function _2f(_30, _31, _32) {
		...
		var _34 = "expand" + _31.substring(0, 1).toUpperCase()
				+ _31.substring(1);
		if (!_33[_34]) {
			_33[_34] = _35(_31);
		...
		function _37() {
			...
			if (_31 == "east") {
				return {
					resizeC : {
						width : _33.center.panel("options").width
								+ _33["east"].panel("options").width - 28
					},
					expand : {
				...
				if (_31 == "west") {
					return {
						resizeC : {
							width : _33.center.panel("options").width
									+ _33["west"].panel("options").width - 28,
							left : 28
						},
						expand : {
							left : 0
					...
					if (_31 == "north") {
						...
						if (_31 == "south") {
							...
							return {
								...
								expand : {
									top : cc.height()
											- _33["south"].panel("options").height
								},
								expandP : {
									top : cc.height() - 28,
									left : 0,
	...
	function _3a(_3b, _3c) {
		...
		var _40 = "expand" + _3c.substring(0, 1).toUpperCase()
				+ _3c.substring(1);
		_3d[_40].panel("close");
		...
		function _3f() {
			...
			if (_3c == "east" && _3d.expandEast) {
				return {
					...
					expand : {
						left : cc.width() - _3d["east"].panel("options").width
					}
				};
			} else {
				if (_3c == "west" && _3d.expandWest) {
					return {
						collapse : {
							left : -_3d["west"].panel("options").width
						},
						expand : {
							left : 0
						}
					...
					if (_3c == "north" && _3d.expandNorth) {
						return {
							collapse : {
								top : -_3d["north"].panel("options").height
							},
							expand : {
								top : 0
							}
						...
						if (_3c == "south" && _3d.expandSouth) {
							return {
								...
								expand : {
									top : cc.height()
											- _3d["south"].panel("options").height
								}
							};
						}
					}
	...
	$.fn.layout = function(_44, _45) {
		...
		return this.each(function() {
					...
					if (_46) {
						...
						var _47 = $.extend({}, $.fn.layout.defaults,
								$.fn.layout.parseOptions(this), _44);
						$.data(this, "layout", {
									options : _47,
									panels : {
										center : $(),
	...
	$.fn.layout.parseOptions = function(_4d) {
		return $.extend({}, $.parser.parseOptions(_4d, [{
									fit : "boolean"
								}]));
	};
	$.fn.layout.defaults = {
