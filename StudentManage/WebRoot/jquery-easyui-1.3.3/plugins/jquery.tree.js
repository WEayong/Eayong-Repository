...
(function($) {
	...
	function _4(_5) {
		...
		function _7(aa, _8) {
			_8.children("li").each(function() {
				var _9 = $(this);
				var _a = $.extend({}, $.parser.parseOptions(this, ["id",
										"iconCls", "state"]), {
	...
	function _18(_19) {
		...
		function _22(_2d, _2e) {
			...
			_2f.removeClass("tree-dnd-yes tree-dnd-no").addClass(_2e
					? "tree-dnd-yes"
					: "tree-dnd-no");
		};
	...
	function _52(_53, ul, _54, _55) {
		...
		function _59(ul, _5c, _5d) {
			for (var i = 0; i < _5c.length; i++) {
				...
				$("<span class=\"tree-title\"></span>").html(_56.formatter
						.call(_53, _5e)).appendTo(_5f);
				if (_56.checkbox) {
	...
	function _b6(_b7, _b8) {
		...
		if (ul.children("li").length == 0) {
			var _ba = ul.prev();
			_ba.find(".tree-icon").removeClass("tree-folder")
					.addClass("tree-file");
	...
	function _14(_c9, _ca) {
		var _cb = $.extend({}, $.data(_ca, "tree-node"), {
					target : _ca,
					checked : $(_ca).find(".tree-checkbox")
							.hasClass("tree-checkbox1")
				});
		if (!_4d(_c9, _ca)) {
			_cb.state = $(_ca).find(".tree-hit").hasClass("tree-expanded")
					? "open"
					: "closed";
		}
		return _cb;
	...
	function _d7(_d8, _d9) {
		...
		_dd.width(_dc + 20);
		_dd.height(document.compatMode == "CSS1Compat" ? (18 - (_dd
				.outerHeight() - _dd.height())) : 18);
	...
	$.fn.tree = function(_e9, _ea) {
		...
		return this.each(function() {
					...
					if (_eb) {
						...
						_ec = $.extend({}, $.fn.tree.defaults, $.fn.tree
										.parseOptions(this), _e9);
						$.data(this, "tree", {
									options : _ec,
									tree : _1(this)
								});
