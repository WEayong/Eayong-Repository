...
(function($) {
	...
	function _13(e) {
		...
		_14.droppables.each(function() {
			...
			var p2 = _16.offset();
			if (e.pageX > p2.left && e.pageX < p2.left + _16.outerWidth()
					&& e.pageY > p2.top && e.pageY < p2.top + _16.outerHeight()) {
				if (!this.entered) {
	...
	$.fn.draggable = function(_20, _21) {
		...
		return this.each(function() {
					...
					if (typeof _22.handle == "undefined" || _22.handle == null) {
						...
						_24 = (typeof _22.handle == "string" ? $(_22.handle,
								this) : _22.handle);
					}
					$.data(this, "draggable", {
								options : _22,
	...
	$(function() {
				function _31(e) {
					...
					_35.initMouseEvent(_34, true, true, window, 1, _33.screenX,
							_33.screenY, _33.clientX, _33.clientY, false,
