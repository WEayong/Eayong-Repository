...
(function($) {
		...
		if (_d.tools) {
			if (typeof _d.tools == "string") {
				...
				for (var i = 0; i < _d.tools.length; i++) {
					var _10 = $("<a href=\"javascript:void(0);\"></a>")
							.appendTo(_f);
					_10[0].onclick = eval(_d.tools[i].handler || function() {
					});
					_10.linkbutton($.extend({}, _d.tools[i], {
								plain : true
							}));
				}
			}
	...
	function _20(_21) {
		...
		$("<div class=\"tabs-header\">"
				...
				+ "</div>" + "</div>").prependTo(_21);
		cc.children("div.tabs-panels").children("div").each(function(i) {
			var _23 = $.extend({}, $.parser.parseOptions(this), {
	...
	function _26(_27) {
		...
		$(".tabs-scroller-left", _29).unbind(".tabs").bind("click.tabs",
				function() {
					$(_27).tabs("scrollBy", -_28.scrollIncrement);
				});
		$(".tabs-scroller-right", _29).unbind(".tabs").bind("click.tabs",
				function() {
					$(_27).tabs("scrollBy", _28.scrollIncrement);
				});
	};
	function _2b(_2c, pp, _2d) {
		...
		_2f.tab.append("<a href=\"javascript:void(0)\" class=\"tabs-inner\">"
				+ "<span class=\"tabs-title\"></span>"
				+ "<span class=\"tabs-icon\"></span>" + "</a>");
		_2f.tab.unbind(".tabs").bind("click.tabs", {
					p : pp
				}, function(e) {
					...
					_2e.options.onContextMenu.call(_2c, e, $(this)
									.find("span.tabs-title").html(), _31(_2c,
									e.data.p));
				});
		$(_2c).tabs("update", {
					tab : pp,
	...
	function _38(_39, _3a) {
		...
		pp.panel($.extend({}, _3a.options, {
					iconCls : (_3a.options.icon ? _3a.options.icon : undefined)
				}));
		...
		if (_3d.closable) {
			...
			var _40 = $("<a href=\"javascript:void(0)\" class=\"tabs-close\"></a>")
					.appendTo(tab);
			_40.bind("click.tabs", {
						p : pp
					}, function(e) {
		...
		if (_3d.tools) {
			var _41 = $("<span class=\"tabs-p-tool\"></span>").insertAfter(tab
					.find("a.tabs-inner"));
	...
	$.fn.tabs.methods = {
		...
		enableTab : function(jq, _70) {
			return jq.each(function() {
						$(this).tabs("getTab", _70).panel("options").tab
								.removeClass("tabs-disabled");
					});
		},
		disableTab : function(jq, _71) {
			return jq.each(function() {
						$(this).tabs("getTab", _71).panel("options").tab
	...
	$.fn.tabs.parseOptions = function(_76) {
		return $.extend({}, $.parser.parseOptions(_76, ["width", "height",
